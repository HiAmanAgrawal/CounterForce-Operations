...
about.onclick = function () {
  location.href =
    "https://github.com/HiAmanAgrawal/CounterForce-Operations/blob/master/README.md";
};
...
window.onload = function () {
  if (gameOver === "true") {
    missionPassed.innerHTML =
      '<img src="./assets/mission_failed.png" alt="mission_failed">';
  } else {
    missionPassed.innerHTML =
      '<img src="./assets/mission_passed.png" alt="mission_passed">';
  }
  showScore();
};
